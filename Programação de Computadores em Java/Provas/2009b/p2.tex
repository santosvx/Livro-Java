...
\item Escreva um programa que leia um número inteiro positivo $n$, 
...
({\tt 7},{\tt 9},{\tt 6},{\tt 7},{\tt 8},{\tt 9},{\tt 10} são os
...
a saída deve ser: {\tt 70} (pois esse é o resultado de $9\times 1 + 8
...
a saída deve ser: {\tt \symbol{34}Não-decrescente\symbol{34}} (pois a
sequência dos {\tt 4} valores {\tt 1},{\tt 2},{\tt 3},{\tt 3} é
não-decrescente).
...
a saída deve ser: {\tt \symbol{34}Nem não-decrescente, nem
não-crescente, nem constante\symbol{34}} (pois a sequência dos {\tt 4}
valores {\tt 1},{\tt 2},{\tt 5},{\tt 3} não é não-decrescente, nem
não-decrescente, nem constante).

Dica: Use três booleanos {\tt naoCrescente}, {\tt naoDecrescente},
{\tt constante}, inicialize-os com {\tt true} e atualize-os ao
percorrer (a partir do segundo valor da sequência) a sequência de
